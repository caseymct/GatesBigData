...
(function() {
    ...
    YAHOO.extend(ColorPicker, YAHOO.util.Element, {
        ...
        /**
         * ReportConstants for any script-generated messages.  The values here
        ...
        /**
         * ReportConstants for the default image locations for img tags that are
        ...
        /**
         * ReportConstants for the control's default default values
         * @property DEFAULT
         * @final
         */
        DEFAULT : {
        ...
        /**
         * ReportConstants for the control's configuration attributes
         * @property OPT
         * @final
         */
        OPT : {
