...
public abstract class APIController {
    ...
    public static final String PARAM_FILTER_TYPE                = "filter";
    public static final String PARAM_INFO_FIELD_NAME            = "infofield";
    ...
    public static final String PARAM_SUGGESTION_CORE            = "suggestioncore";
    ...
    public static final String PARAM_REINDEX    		        = "reindex";
    public static final String PARAM_MAX_RECORDS   	            = "maxrecords";
    public static final String PARAM_COMMIT_EVERY_N_DOCS  	    = "ncommit";
