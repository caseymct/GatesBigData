...
public class HDFS extends Constants {
    ...
    public static final String HDFS_URI_STRING     = constructAddress(HDFS_PROTOCOL, HDFS_SERVER, HDFS_PORT);
    public static final URI HDFS_URI               = URI.create(HDFS_URI_STRING);
    public static final String USERNAME            = "hdfs";

    public static final String USER_DIR_URI        = constructAddress(HDFS_URI_STRING, Arrays.asList("user", USERNAME));
